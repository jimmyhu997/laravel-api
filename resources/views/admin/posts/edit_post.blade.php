    ...
    <div class="container">
        ...
        <form action="{{route("posts.update", $post->id)}}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="content" name="content" rows="7" placeholder="Inserisci il testo del post">{{old('content',$post->content)}}</textarea>
            </div>
            <div class="form-group form-check">
                <input type="checkbox" class="form-check-input" id="posted"  name="posted" {{old('posted',$post->posted)}}>
